    ...
    <div class="modal__content">
      ...
      <div class="modal__text">
        <div class="tp-body--main tp-text--center">
          ...
          <p>Достаточно в период <br/>
            с 18.09.17 по 18.10.17 <br/>
            выложить личную фотографию в Instagram c подписью, рассказывающей ваше отношение к женственности,</p>
          <p>поставить хэштег<br/>
            <span class="highlight">#LoccitaneDivine</span><br/>
            и отметить на фото @loccitane_ru</p>
        ...
        <button class="btn btn--primary-dark btn--center js-modal" data-target="#competition">Закрыть</button>
      </div>
    </div>
  </div>
</div>